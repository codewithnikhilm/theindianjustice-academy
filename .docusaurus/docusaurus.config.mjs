...
export default {
  ...
  "themeConfig": {
    ...
    "metadata": [
      {
        "name": "description",
        "content": "Free law notes, case laws, bare acts and previous year questions for Indian law students — Land Laws, Registration Act, CPC, BNS and more."
      },
      {
        "name": "keywords",
        "content": "law notes, Indian law, land laws, registration act, CPC, BNS, jurisprudence, transfer of property, labour law"
      }
    ],
    "colorMode": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2026 The Indian Justice Academy. Notes for students, freely shared."
    },
    "prism": {
      "theme": {
        "plain": {
